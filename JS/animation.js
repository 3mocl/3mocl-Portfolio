...
// Function that handles the resizing  
...
// Store that last reverse animation
let lastReverseAnimation = "";

// Animations Hero!
function playAnimation(animation, reverseAniation){
    ...
    if(lastReverseAnimation != ""){
        ...
        setTimeout(function(){
            ...
            lastReverseAnimation = reverseAniation;
        },200)
    }
    else{
        heroImage.classList.add(animation)
